                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="left col-md-6 mb-2">
                                ...
                                <span class="bfor font-weight-bold">Outstanding stock with the supplier</span>
                                <span class="after font-weight-bold"><?= isset($_GET['edit']) ? 'edit record '.$_GET["id"].': supplied by '.$supplier : 'Enter outstanding products with the supplier' ?></span>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <button class="btn btn-success p-2" id="rcv">
                                            <span class="bfor">Add stock</span>
