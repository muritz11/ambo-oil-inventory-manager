                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="left col-md-6 mb-2">
                                <i class="fa fa-opencart mr-1"></i>
                                <span class="bfor font-weight-bold">Received stock</span>
                                <span class="after font-weight-bold">Add product you want to receive</span>
                            </div>
                            <div class="right col-md-6">
                                <div class="row">
                                    <div class="col-lg-8"></div>
                                    <div class="col-lg-4">
                                        <button class="btn btn-success p-2" id="rcv">
                                            <span class="bfor">Receive stock</span>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="my_table" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php
                                    dispTable('received_stock', 'supplier');
                                    ?>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="form" id="form">
                            <form action="assets/php/validate.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="supplier" name="name">
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-success" id="save" name="rec_stock">Save</button>
                            </form>
                        </div>
                    </div>
                </div>
